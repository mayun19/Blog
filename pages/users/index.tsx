    ...
    <Layout pageTitle="Users">
      <div className="flex w-full h-full flex-col items-center justify-between lg:p-24 px-6 py-4 gap-6 md:gap-12">
        <div className="container flex flex-col justify-center  overflow-scroll w-full">
          <h1 className="text-2xl mb-5 lg:mb-12 text-center font-semibold">All Users</h1>
          <table className="w-full text-left rtl:text-right">
            <thead className="flex w-full">
              <tr className="flex w-full mb-4">
                ...
                <th className="px-6 py-3 w-1/6 font-medium lg:text-center">Gender</th>
                <th className="px-6 py-3 w-1/6 font-medium lg:text-center">Status</th>
                <th className="px-6 py-3 w-1/6 font-medium lg:text-center">Action</th>
              </tr>
            </thead>
